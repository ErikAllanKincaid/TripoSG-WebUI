...
cp TripoSG-WebUI/app.py TripoSG-WebUI/pyproject.toml TripoSG-WebUI/requirements.txt TripoSG/
cd TripoSG
uv init
uv venv
...
cd ~/code/TripoSG
IMAGE=image.jpg
uv run python -m scripts.inference_triposg --image-input "$(pwd)/$IMAGE"
```
